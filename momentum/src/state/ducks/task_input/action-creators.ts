...
export function addTask(taskName: string, priority: string, estimation: number, description: string) {
  return {
...
export function removeTask(taskName: string) {
  return {
...
export function addTaskTime(taskName: string, time: number) {
  return {
